# TDD for quick exercise

Method Test drive development for Solver class
...
Quick exercise where we put in practice the TDD method for Rspec
...
```sh
  ...
  git clone git@github.com:enmanuelbayen/tdd.git
```
